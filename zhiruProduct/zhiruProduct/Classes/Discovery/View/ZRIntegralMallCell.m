...
-(void)drawRect:(CGRect)rect
{
    if (_commodityList) {
        ...
        CGSize size1 = [self drawWithStr:_commodityList.commodityName Font:CustomFont(13) Color:RGBCOLOR(85, 85, 85) Point:CGPointMake(5, (self.width*0.6)+5) Size:CGSizeMake(self.width, size.height*2)];
        
        //VIP图标
        [self drawImage:ZRImage(@"VIP") Rect:CGRectMake(5, (self.width*0.6)+5+size1.height+5, 18, 18)];
        
        //VIP积分
         [self drawWithStr:_commodityList.vipfraction Font:CustomFont(13) Color:RGBCOLOR(85, 85, 85) Point:CGPointMake(5+18+10, (self.width*0.6)+5+size1.height+5)];
        
        //添加金币
        [self drawImage:ZRImage(@"jifenyue-81") Rect:CGRectMake(5, (self.width*0.6)+5+(size1.height+5)*2+5, 18, 18)];
        
        
        //所需积分
        [self drawWithStr:_commodityList.fraction Font:CustomFont(13) Color:RGBCOLOR(85, 85, 85) Point:CGPointMake(5+18+10, (self.width*0.6)+5+(size1.height+5)*2+5)];
