...
- (void)createHeaderView
{
    ...
    self.lineView.backgroundColor = RGBCOLOR(240, 239, 245);
    ...
    [self.vipLabel setTextColor:RGBCOLOR(255, 82, 82)];
...
- (void)setHeaderMasonary
{
    ...
    [self.vipLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(weakSelf.headerView);
        make.left.equalTo(weakSelf.userNameLabel.mas_right).with.offset(10);
    }];
...
- (void)createFooterView
{
    ...
    [_footerView1.img setImage:ZRImage(@"WODEQIANBAO")];
    
    
    self.footerLine1 = [[UIView alloc] initWithFrame:CGRectMake(width, 0, 1, height)];
    [self.footerLine1 setBackgroundColor:RGBCOLOR(240, 239, 245)];
    ...
    [_footerView2.img setImage:ZRImage(@"WODEJIFEN")];
    
    
    self.footerLine2 = [[UIView alloc] initWithFrame:CGRectMake(width * 2, 0, 1, height)];
    [self.footerLine2 setBackgroundColor:RGBCOLOR(240, 239, 245)];
    ...
    [_footerView3.img setImage:ZRImage(@"wode_jifenshangcheng")];
}
