...
- (void)setUpAdView:(NSArray *)urlArr SuperView:(ZRSupermarketCell *)cell
{
    ...
    self.adView = [AdView adScrollViewWithFrame:CGRectMake(0, 0, ScreenWidth, cell.height) bundleImageLinkURL:urlArr pageControlShowStyle:UIPageControlShowStyleCenter];
