...
-(void)drawRect:(CGRect)rect
{
    if (_goodsListModel) {
        ...
        CGSize goodsSize = [self drawWithStr:_goodsListModel.goods_name Font:[UIFont systemFontOfSize:14] Color:RGBCOLOR(85, 85, 85) Point:CGPointMake(x+width+x, y) Size:CGSizeMake(self.width-(width+30),  self.height)];
