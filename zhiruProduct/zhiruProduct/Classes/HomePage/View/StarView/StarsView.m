...
- (instancetype)initWithStarSize:(CGSize)size space:(CGFloat)space numberOfStar:(NSInteger)number starHighLightImage:(NSString *)LightImage starNormalImage: (NSString *)normalImage{
    self = [super init];
    if (self) {
        _selectable = YES;
        ...
        for (int i = 0; i < number; i ++) {
            ...
            starView.lightImage = LightImage;
            starView.normalImage = normalImage;
