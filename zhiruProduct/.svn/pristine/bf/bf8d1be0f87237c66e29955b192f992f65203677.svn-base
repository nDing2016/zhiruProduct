...
- (void)viewDidLoad {
    ...
    UIBarButtonItem * item = [UIBarButtonItem itemWithImage:[UIImage imageNamed:@"cha"] highImage:[UIImage imageNamed:@"cha"]  target:self action:@selector(actionLeftChaButton)];
    self.navigationItem.leftBarButtonItem = item;
}
- (void)actionLeftChaButton
{
...
//    [self dismissViewControllerAnimated:YES completion:nil];
    ...
    if (self.returnCountryCodeBlock != nil) {
        ...
        NSString * quhao = [NSString stringWithFormat:@"+%@", [array lastObject]];
        self.returnCountryCodeBlock(quhao);
    }
    [self dismissViewControllerAnimated:YES completion:nil];
}
